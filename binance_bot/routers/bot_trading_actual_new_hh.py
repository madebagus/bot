...
MARKET_ORDER_FEE = 0.001  # 0.1% fee

def atr_decision(df, symbol, window=14, atr_multiplier_stop=2, atr_multiplier_take_profit=4):
    ...
    if trend == 'BUY':
            ...
            take_profit = latest_close * 0.985
...
coin_pairs = ['DOTUSDT', 'ETHUSDT', 'BNBUSDT', 'LTCUSDT']  # Example with 4 pairs
